...
/// @notice PermitBundler contract specific to the Ethereum mainnet, handling permit to DAI.
abstract contract EthereumPermitBundler is PermitBundler {
    ...
    function permitDai(uint256 nonce, uint256 expiry, bool allowed, uint8 v, bytes32 r, bytes32 s, bool skipRevert)
        ...
        payable
    {
        try IDaiPermit(MainnetLib.DAI).permit(_initiator, address(this), nonce, expiry, allowed, v, r, s) {}
