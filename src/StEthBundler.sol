...
abstract contract StEthBundler is BaseBundler {
    ...
    /// @dev Use `TransferBundler.erc20Transfer` to transfer the stEth to some receiver.
    ...
    /// @dev Use `TransferBundler.erc20Transfer` to transfer the wrapped stEth to some receiver.
    ...
    /// @dev Use `TransferBundler.erc20Transfer` to transfer the unwrapped stEth to some receiver.
