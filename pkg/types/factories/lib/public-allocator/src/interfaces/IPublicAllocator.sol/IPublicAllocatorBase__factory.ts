...
export class IPublicAllocatorBase__factory {
  static readonly abi = _abi;
  static createInterface(): IPublicAllocatorBaseInterface {
    return new Interface(_abi) as IPublicAllocatorBaseInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as IPublicAllocatorBase;
  }
}
