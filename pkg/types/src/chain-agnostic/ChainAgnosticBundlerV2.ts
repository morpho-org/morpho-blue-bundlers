...
export interface ChainAgnosticBundlerV2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "MORPHO"
      | "WRAPPED_NATIVE"
...
export interface ChainAgnosticBundlerV2 extends BaseContract {
  connect(runner?: ContractRunner | null): ChainAgnosticBundlerV2;
  waitForDeployment(): Promise<this>;

  interface: ChainAgnosticBundlerV2Interface;
