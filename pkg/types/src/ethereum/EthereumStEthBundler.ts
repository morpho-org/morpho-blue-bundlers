...
export interface EthereumStEthBundlerInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ST_ETH"
      | "WST_ETH"
...
export interface EthereumStEthBundler extends BaseContract {
  connect(runner?: ContractRunner | null): EthereumStEthBundler;
  waitForDeployment(): Promise<this>;

  interface: EthereumStEthBundlerInterface;
