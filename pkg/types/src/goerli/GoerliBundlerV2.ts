...
export interface GoerliBundlerV2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "MORPHO"
      | "ST_ETH"
...
export interface GoerliBundlerV2 extends BaseContract {
  connect(runner?: ContractRunner | null): GoerliBundlerV2;
  waitForDeployment(): Promise<this>;

  interface: GoerliBundlerV2Interface;
