...
export interface AaveV3MigrationBundlerV2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "AAVE_V3_POOL"
      | "MORPHO"
  ...
  encodeFunctionData(
    functionFragment: "AAVE_V3_POOL",
    values?: undefined
  ): string;
  encodeFunctionData(functionFragment: "MORPHO", values?: undefined): string;
  encodeFunctionData(
    functionFragment: "aaveV3Repay",
    values: [AddressLike, BigNumberish, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "aaveV3Withdraw",
...
export interface AaveV3MigrationBundlerV2 extends BaseContract {
  connect(runner?: ContractRunner | null): AaveV3MigrationBundlerV2;
  waitForDeployment(): Promise<this>;

  interface: AaveV3MigrationBundlerV2Interface;
  ...
  AAVE_V3_POOL: TypedContractMethod<[], [string], "view">;

  MORPHO: TypedContractMethod<[], [string], "view">;

  aaveV3Repay: TypedContractMethod<
    [asset: AddressLike, amount: BigNumberish, interestRateMode: BigNumberish],
    [void],
    "payable"
  >;

  aaveV3Withdraw: TypedContractMethod<
  ...
  getFunction(
    nameOrSignature: "AAVE_V3_POOL"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
    nameOrSignature: "MORPHO"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
    nameOrSignature: "aaveV3Repay"
  ): TypedContractMethod<
    [asset: AddressLike, amount: BigNumberish, interestRateMode: BigNumberish],
    [void],
    "payable"
  >;
  getFunction(
    nameOrSignature: "aaveV3Withdraw"
  ): TypedContractMethod<
    [asset: AddressLike, amount: BigNumberish],
    [void],
    "payable"
