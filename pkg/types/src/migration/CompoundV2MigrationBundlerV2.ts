...
export interface CompoundV2MigrationBundlerV2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "C_ETH"
      | "MORPHO"
  ...
  encodeFunctionData(functionFragment: "C_ETH", values?: undefined): string;
  ...
  encodeFunctionData(
    functionFragment: "compoundV2Redeem",
    values: [AddressLike, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "compoundV2Repay",
    values: [AddressLike, BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "C_ETH", data: BytesLike): Result;
...
export interface CompoundV2MigrationBundlerV2 extends BaseContract {
  connect(runner?: ContractRunner | null): CompoundV2MigrationBundlerV2;
  waitForDeployment(): Promise<this>;

  interface: CompoundV2MigrationBundlerV2Interface;
  ...
  C_ETH: TypedContractMethod<[], [string], "view">;
  ...
  compoundV2Redeem: TypedContractMethod<
    [cToken: AddressLike, amount: BigNumberish],
    [void],
    "payable"
  >;

  compoundV2Repay: TypedContractMethod<
    [cToken: AddressLike, amount: BigNumberish],
    [void],
    "payable"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "compoundV2Redeem"
  ): TypedContractMethod<
    [cToken: AddressLike, amount: BigNumberish],
    [void],
    "payable"
  >;
  getFunction(
    nameOrSignature: "compoundV2Repay"
  ): TypedContractMethod<
    [cToken: AddressLike, amount: BigNumberish],
    [void],
    "payable"
