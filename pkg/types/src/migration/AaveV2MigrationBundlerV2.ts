...
export interface AaveV2MigrationBundlerV2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "AAVE_V2_POOL"
      | "MORPHO"
  ...
  encodeFunctionData(
    functionFragment: "aaveV2Repay",
    values: [AddressLike, BigNumberish, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "aaveV2Withdraw",
...
export interface AaveV2MigrationBundlerV2 extends BaseContract {
  connect(runner?: ContractRunner | null): AaveV2MigrationBundlerV2;
  waitForDeployment(): Promise<this>;

  interface: AaveV2MigrationBundlerV2Interface;
  ...
  AAVE_V2_POOL: TypedContractMethod<[], [string], "view">;
  ...
  >;
  getFunction(
    nameOrSignature: "aaveV2Withdraw"
  ): TypedContractMethod<
    [asset: AddressLike, amount: BigNumberish],
    [void],
    "payable"
