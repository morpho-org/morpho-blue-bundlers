...
export interface SepoliaBundlerV2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "MORPHO"
      | "ST_ETH"
...
export interface SepoliaBundlerV2 extends BaseContract {
  connect(runner?: ContractRunner | null): SepoliaBundlerV2;
  waitForDeployment(): Promise<this>;

  interface: SepoliaBundlerV2Interface;
