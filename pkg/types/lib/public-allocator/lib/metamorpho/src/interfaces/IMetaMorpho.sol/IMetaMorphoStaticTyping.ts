...
export interface IMetaMorphoStaticTypingInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DECIMALS_OFFSET"
      | "MORPHO"
...
export interface IMetaMorphoStaticTyping extends BaseContract {
  connect(runner?: ContractRunner | null): IMetaMorphoStaticTyping;
  waitForDeployment(): Promise<this>;

  interface: IMetaMorphoStaticTypingInterface;
  ...
  pendingGuardian: TypedContractMethod<
    [],
    [[string, bigint] & { guardian: string; validAt: bigint }],
    "view"
  >;
