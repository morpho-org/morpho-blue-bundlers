...
export interface IPublicAllocatorBaseInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "MORPHO"
      | "accruedFee"
...
export interface IPublicAllocatorBase extends BaseContract {
  connect(runner?: ContractRunner | null): IPublicAllocatorBase;
  waitForDeployment(): Promise<this>;

  interface: IPublicAllocatorBaseInterface;
