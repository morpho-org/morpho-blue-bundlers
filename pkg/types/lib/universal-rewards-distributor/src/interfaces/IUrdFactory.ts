...
export interface IUrdFactoryInterface extends Interface {
...
export interface IUrdFactory extends BaseContract {
  connect(runner?: ContractRunner | null): IUrdFactory;
  waitForDeployment(): Promise<this>;

  interface: IUrdFactoryInterface;
  ...
  isUrd: TypedContractMethod<[target: AddressLike], [boolean], "view">;
