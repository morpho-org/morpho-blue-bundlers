...
export type PendingRootStruct = {
  root: BytesLike;
  ipfsHash: BytesLike;
  validAt: BigNumberish;
};

export type PendingRootStructOutput = [
  root: string,
  ipfsHash: string,
  validAt: bigint
] & { root: string; ipfsHash: string; validAt: bigint };

export interface IUniversalRewardsDistributorInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "acceptRoot"
      | "claim"
...
export interface IUniversalRewardsDistributor extends BaseContract {
  connect(runner?: ContractRunner | null): IUniversalRewardsDistributor;
  waitForDeployment(): Promise<this>;

  interface: IUniversalRewardsDistributorInterface;
  ...
  pendingRoot: TypedContractMethod<[], [PendingRootStructOutput], "view">;
  ...
  ): TypedContractMethod<[], [PendingRootStructOutput], "view">;
  getFunction(
