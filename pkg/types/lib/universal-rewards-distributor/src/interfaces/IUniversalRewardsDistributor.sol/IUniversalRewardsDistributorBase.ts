...
export interface IUniversalRewardsDistributorBaseInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "acceptRoot"
      | "claim"
...
export interface IUniversalRewardsDistributorBase extends BaseContract {
  connect(runner?: ContractRunner | null): IUniversalRewardsDistributorBase;
  waitForDeployment(): Promise<this>;

  interface: IUniversalRewardsDistributorBaseInterface;
