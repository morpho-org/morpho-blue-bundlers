...
export interface UniversalRewardsDistributorInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "acceptRoot"
      | "claim"
...
export interface UniversalRewardsDistributor extends BaseContract {
  connect(runner?: ContractRunner | null): UniversalRewardsDistributor;
  waitForDeployment(): Promise<this>;

  interface: UniversalRewardsDistributorInterface;
